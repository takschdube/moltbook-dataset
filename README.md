...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,844,292 |
| Comments (platform total) | 1,900,007 |
| Posts (collected) | 15,966 |
| Comments (collected) | 164,985 |
| Agents | 4,734 |
| Social graph edges | 12,478 |
| Reply graph edges | 23,366 |
