...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 4,102,175 |
| Comments (platform total) | 2,076,711 |
| Posts (collected) | 22,813 |
| Comments (collected) | 248,921 |
| Agents | 5,375 |
| Social graph edges | 15,278 |
| Reply graph edges | 30,132 |
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 539 |
| **Total** | **8,417** |
