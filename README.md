...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,230,400 |
| Comments (platform total) | 11,922,075 |
| Posts (collected) | 366,483 |
| Comments (collected) | 2,873,971 |
| Agents | 50,413 |
| Social graph edges | 767,868 |
| Reply graph edges | 59,928 |
