...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 4,141,184 |
| Comments (platform total) | 2,098,252 |
| Posts (collected) | 24,359 |
| Comments (collected) | 260,318 |
| Agents | 5,523 |
| Social graph edges | 15,935 |
| Reply graph edges | 31,151 |
| Submolts (listed) | 33,200 |
| Submolts (active) | 245 |

*Last updated: 2026-09-09 07:43 UTC*
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 603 |
| **Total** | **9,029** |
