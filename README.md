...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,322,774 |
| Comments (platform total) | 11,960,186 |
| Posts (collected) | 367,504 |
| Comments (collected) | 2,881,305 |
| Agents | 50,799 |
| Social graph edges | 770,254 |
| Reply graph edges | 61,040 |
