...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,612,008 |
| Comments (platform total) | 1,756,619 |
| Posts (collected) | 10,501 |
| Comments (collected) | 86,498 |
| Agents | 4,173 |
| Social graph edges | 8,388 |
| Reply graph edges | 15,078 |
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 807 |
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 58 |
| **Total** | **16,274** |
