...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,261,979 |
| Comments (platform total) | 11,935,663 |
| Posts (collected) | 366,825 |
| Comments (collected) | 2,876,478 |
| Agents | 50,532 |
| Social graph edges | 768,714 |
| Reply graph edges | 60,249 |
| Submolts (active) | 4,665 |
