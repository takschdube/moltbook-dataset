...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,504,931 |
| Comments (platform total) | 1,681,334 |
| Posts (collected) | 7,668 |
| Comments (collected) | 55,488 |
| Agents | 3,801 |
| Social graph edges | 5,999 |
| Reply graph edges | 10,799 |
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 731 |
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 14 |
| **Total** | **14,195** |
