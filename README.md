...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,426,965 |
| Comments (platform total) | 1,628,178 |
| Posts (collected) | 5,619 |
| Comments (collected) | 33,068 |
| Agents | 3,404 |
| Social graph edges | 4,379 |
| Reply graph edges | 6,809 |
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 699 |
