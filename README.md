...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,207,482 |
| Comments (platform total) | 11,911,405 |
| Posts (collected) | 366,200 |
| Comments (collected) | 2,872,379 |
| Agents | 50,274 |
| Social graph edges | 767,011 |
| Reply graph edges | 59,753 |
| Submolts (active) | 4,653 |
