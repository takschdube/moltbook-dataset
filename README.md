...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,544,365 |
| Comments (platform total) | 12,090,752 |
| Posts (collected) | 372,520 |
| Comments (collected) | 3,146,873 |
| Agents | 51,816 |
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 237 |
