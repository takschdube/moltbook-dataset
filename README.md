...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,884,061 |
| Comments (platform total) | 1,925,292 |
| Posts (collected) | 16,908 |
| Comments (collected) | 177,054 |
| Agents | 4,807 |
| Social graph edges | 12,878 |
| Reply graph edges | 24,514 |
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 335 |
| **Total** | **6,959** |
