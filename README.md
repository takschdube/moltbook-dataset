...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,338,220 |
| Comments (platform total) | 11,966,904 |
| Posts (collected) | 367,737 |
| Comments (collected) | 2,883,958 |
| Agents | 50,909 |
| Social graph edges | 770,803 |
| Reply graph edges | 61,672 |
