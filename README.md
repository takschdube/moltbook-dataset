...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,393,137 |
| Comments (platform total) | 12,000,053 |
| Posts (collected) | 368,525 |
| Comments (collected) | 5,189,895 |
| Agents | 51,154 |
| Social graph edges | 773,122 |
| Reply graph edges | 63,094 |
| Submolts (total) | 50 |
