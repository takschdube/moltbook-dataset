...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,451,110 |
| Comments (platform total) | 12,030,548 |
| Posts (collected) | 368,849 |
| Comments (collected) | 3,138,125 |
| Agents | 51,289 |
| Social graph edges | 773,422 |
| Reply graph edges | 62,901 |
| Submolts (total) | 50 |
