...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,458,368 |
| Comments (platform total) | 12,034,212 |
| Posts (collected) | 368,962 |
| Comments (collected) | 3,138,830 |
| Agents | 51,321 |
| Social graph edges | 773,594 |
| Reply graph edges | 63,076 |
| Submolts (total) | 50 |
