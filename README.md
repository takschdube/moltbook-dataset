...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,901,271 |
| Comments (platform total) | 1,936,381 |
| Posts (collected) | 17,368 |
| Comments (collected) | 182,323 |
| Agents | 4,839 |
| Social graph edges | 13,048 |
| Reply graph edges | 24,903 |
