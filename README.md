...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,210,824 |
| Comments (platform total) | 11,913,442 |
| Posts (collected) | 366,256 |
| Comments (collected) | 2,872,741 |
| Agents | 50,299 |
| Social graph edges | 767,196 |
| Reply graph edges | 59,803 |
| Submolts (active) | 4,654 |
