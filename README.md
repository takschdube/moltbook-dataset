...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,867,976 |
| Comments (platform total) | 12,247,382 |
| Posts (collected) | 381,641 |
| Comments (collected) | 3,186,034 |
| Agents | 52,795 |
| Social graph edges | 781,424 |
| Reply graph edges | 70,532 |
| Submolts (listed) | 25,000 |
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 402 |
