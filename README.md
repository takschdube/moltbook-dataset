...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,638,811 |
| Comments (platform total) | 1,769,087 |
| Posts (collected) | 11,148 |
| Comments (collected) | 93,635 |
| Agents | 4,283 |
| Social graph edges | 8,903 |
| Reply graph edges | 16,072 |
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 827 |
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 79 |
| **Total** | **16,360** |
