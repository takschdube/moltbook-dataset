...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,977,709 |
| Comments (platform total) | 1,996,177 |
| Posts (collected) | 19,620 |
| Comments (collected) | 209,100 |
| Agents | 5,069 |
| Social graph edges | 13,984 |
| Reply graph edges | 27,112 |
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 440 |
| **Total** | **7,732** |
