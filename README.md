...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,235,309 |
| Comments (platform total) | 11,924,873 |
| Posts (collected) | 366,541 |
| Comments (collected) | 2,874,171 |
| Agents | 50,433 |
| Social graph edges | 767,967 |
| Reply graph edges | 59,959 |
| Submolts (active) | 4,659 |
