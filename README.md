...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,816,271 |
| Comments (platform total) | 1,883,967 |
| Posts (collected) | 15,319 |
| Comments (collected) | 157,082 |
| Agents | 4,691 |
| Social graph edges | 12,237 |
| Reply graph edges | 22,667 |
