...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,635,698 |
| Comments (platform total) | 1,768,289 |
| Posts (collected) | 11,093 |
| Comments (collected) | 92,879 |
| Agents | 4,271 |
| Social graph edges | 8,844 |
| Reply graph edges | 15,935 |
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 826 |
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 72 |
| **Total** | **16,352** |
