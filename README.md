...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,454,383 |
| Comments (platform total) | 12,031,462 |
| Posts (collected) | 368,903 |
| Comments (collected) | 3,138,535 |
| Agents | 51,307 |
| Social graph edges | 773,548 |
| Reply graph edges | 63,016 |
| Submolts (total) | 50 |
| Submolts (active) | 4,690 |
