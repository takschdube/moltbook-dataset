...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,875,814 |
| Comments (platform total) | 1,918,811 |
| Posts (collected) | 16,678 |
| Comments (collected) | 174,179 |
| Agents | 4,793 |
| Social graph edges | 12,800 |
| Reply graph edges | 24,269 |
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 325 |
| **Total** | **6,912** |
