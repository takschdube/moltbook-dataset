...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,299,307 |
| Comments (platform total) | 11,950,234 |
| Posts (collected) | 367,221 |
| Comments (collected) | 2,879,573 |
| Agents | 50,687 |
| Social graph edges | 769,606 |
| Reply graph edges | 60,655 |
| Submolts (active) | 4,670 |
