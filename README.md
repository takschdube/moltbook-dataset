...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,465,563 |
| Comments (platform total) | 1,657,133 |
| Posts (collected) | 6,740 |
| Comments (collected) | 44,242 |
| Agents | 3,621 |
| Social graph edges | 5,299 |
| Reply graph edges | 9,069 |
| Submolts (listed) | 32,150 |
| Submolts (active) | 91 |

*Last updated: 2026-06-27 07:48 UTC*
...
| Platform | Downloads |
|----------|-----------|
| [Zenodo](https://doi.org/10.5281/zenodo.19470480) | 3,588 |
| [Hugging Face](https://huggingface.co/datasets/takschdube/moltbook-dataset) | 4,028 |
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 716 |
