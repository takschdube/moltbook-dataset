...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,947,019 |
| Comments (platform total) | 1,975,490 |
| Posts (collected) | 18,687 |
| Comments (collected) | 198,784 |
| Agents | 4,984 |
| Social graph edges | 13,709 |
| Reply graph edges | 26,302 |
