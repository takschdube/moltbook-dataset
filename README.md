...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,805,534 |
| Comments (platform total) | 1,878,369 |
| Posts (collected) | 15,034 |
| Comments (collected) | 154,310 |
| Agents | 4,671 |
| Social graph edges | 12,103 |
| Reply graph edges | 22,399 |
