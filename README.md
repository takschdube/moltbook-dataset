...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 4,156,546 |
| Comments (platform total) | 2,105,284 |
| Posts (collected) | 24,781 |
| Comments (collected) | 264,198 |
| Agents | 5,562 |
| Social graph edges | 16,167 |
| Reply graph edges | 31,445 |
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 627 |
| **Total** | **9,142** |
