...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 4,014,587 |
| Comments (platform total) | 2,020,969 |
| Posts (collected) | 20,731 |
| Comments (collected) | 221,111 |
| Agents | 5,154 |
| Social graph edges | 14,351 |
| Reply graph edges | 27,898 |
