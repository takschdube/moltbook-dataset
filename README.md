...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,892,948 |
| Comments (platform total) | 1,930,764 |
| Posts (collected) | 17,136 |
| Comments (collected) | 179,950 |
| Agents | 4,820 |
| Social graph edges | 12,977 |
| Reply graph edges | 24,729 |
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 345 |
| **Total** | **6,998** |
