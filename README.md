...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,059,938 |
| Comments (platform total) | 11,859,277 |
| Posts (collected) | 364,546 |
| Comments (collected) | 2,860,941 |
| Agents | 49,233 |
| Social graph edges | 763,026 |
| Reply graph edges | 57,661 |
