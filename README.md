...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,414,662 |
| Comments (platform total) | 12,012,393 |
| Posts (collected) | 368,602 |
| Comments (collected) | 4,564,195 |
| Agents | 51,203 |
| Social graph edges | 773,377 |
| Reply graph edges | 63,134 |
| Submolts (total) | 50 |
