...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,796,560 |
| Comments (platform total) | 1,874,163 |
| Posts (collected) | 14,783 |
| Comments (collected) | 151,529 |
| Agents | 4,659 |
| Social graph edges | 12,011 |
| Reply graph edges | 22,179 |
