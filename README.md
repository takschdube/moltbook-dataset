...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,486,796 |
| Comments (platform total) | 1,668,889 |
| Posts (collected) | 7,197 |
| Comments (collected) | 48,858 |
| Agents | 3,719 |
| Social graph edges | 5,609 |
| Reply graph edges | 9,814 |
| Submolts (listed) | 32,150 |
| Submolts (active) | 101 |

*Last updated: 2026-06-29 08:16 UTC*
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 724 |
