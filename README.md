...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,462,453 |
| Comments (platform total) | 12,036,635 |
| Posts (collected) | 369,019 |
| Comments (collected) | 3,139,161 |
| Agents | 51,335 |
| Social graph edges | 773,614 |
| Reply graph edges | 63,128 |
| Submolts (total) | 50 |
