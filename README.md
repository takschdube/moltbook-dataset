...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,776,009 |
| Comments (platform total) | 1,862,777 |
| Posts (collected) | 14,258 |
| Comments (collected) | 145,018 |
| Agents | 4,623 |
| Social graph edges | 11,647 |
| Reply graph edges | 21,610 |
...
| 2026-07 | 17 | 1,080 | 114 | 232 | 1,443 |
