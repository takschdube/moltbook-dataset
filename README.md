...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,153,236 |
| Comments (platform total) | 11,883,352 |
| Posts (collected) | 365,596 |
| Comments (collected) | 2,868,058 |
| Agents | 49,967 |
| Social graph edges | 764,941 |
| Reply graph edges | 58,997 |
