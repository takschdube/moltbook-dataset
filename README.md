...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,492,612 |
| Comments (platform total) | 12,052,414 |
| Posts (collected) | 369,476 |
| Comments (collected) | 3,142,649 |
| Agents | 51,476 |
| Social graph edges | 774,482 |
| Reply graph edges | 63,757 |
| Submolts (total) | 50 |
