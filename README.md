...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,216,173 |
| Comments (platform total) | 11,915,533 |
| Posts (collected) | 366,313 |
| Comments (collected) | 2,873,058 |
| Agents | 50,324 |
| Social graph edges | 767,318 |
| Reply graph edges | 59,835 |
| Submolts (active) | 4,656 |
