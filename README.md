...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,856,413 |
| Comments (platform total) | 1,906,529 |
| Posts (collected) | 16,254 |
| Comments (collected) | 168,795 |
| Agents | 4,759 |
| Social graph edges | 12,608 |
| Reply graph edges | 23,725 |
