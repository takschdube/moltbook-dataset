...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,226,022 |
| Comments (platform total) | 11,920,564 |
| Posts (collected) | 366,428 |
| Comments (collected) | 2,873,588 |
| Agents | 50,379 |
| Social graph edges | 767,632 |
| Reply graph edges | 59,887 |
| Submolts (active) | 4,658 |
