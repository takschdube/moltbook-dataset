...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 4,132,940 |
| Comments (platform total) | 2,094,255 |
| Posts (collected) | 24,026 |
| Comments (collected) | 258,603 |
| Agents | 5,493 |
| Social graph edges | 15,878 |
| Reply graph edges | 31,016 |
