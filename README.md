...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,682,242 |
| Comments (platform total) | 1,801,084 |
| Posts (collected) | 11,994 |
| Comments (collected) | 105,160 |
| Agents | 4,409 |
| Social graph edges | 9,839 |
| Reply graph edges | 17,579 |
