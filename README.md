...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,956,036 |
| Comments (platform total) | 1,981,452 |
| Posts (collected) | 18,978 |
| Comments (collected) | 201,771 |
| Agents | 5,007 |
| Social graph edges | 13,784 |
| Reply graph edges | 26,492 |
