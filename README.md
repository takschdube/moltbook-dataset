...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,111,817 |
| Comments (platform total) | 11,874,933 |
| Posts (collected) | 365,119 |
| Comments (collected) | 2,864,383 |
| Agents | 49,596 |
| Social graph edges | 764,174 |
| Reply graph edges | 58,275 |
