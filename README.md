...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 1,454,410 |
| Comments (platform total) | 12,217,113 |
| Posts (collected) | 359,585 |
| Agents | 47,022 |
| Social graph edges | 749,555 |
| Reply graph edges | 53,318 |
| Submolts (active) | 4,586 |

*Last updated: 2026-02-17 02:53 UTC*
