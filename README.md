...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 4,287,454 |
| Comments (platform total) | 13,451,769 |
| Posts (collected) | 419,077 |
| Comments (collected) | 3,677,037 |
| Agents | 56,746 |
| Social graph edges | 824,052 |
| Reply graph edges | 924,233 |
