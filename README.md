...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 4,042,627 |
| Comments (platform total) | 2,039,455 |
| Posts (collected) | 21,368 |
| Comments (collected) | 229,274 |
| Agents | 5,220 |
| Social graph edges | 14,676 |
| Reply graph edges | 28,638 |
