...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,083,436 |
| Comments (platform total) | 11,865,628 |
| Posts (collected) | 364,772 |
| Comments (collected) | 2,862,172 |
| Agents | 49,376 |
| Social graph edges | 763,480 |
| Reply graph edges | 57,828 |
