...
| Comments (collected) | 275,867 |
| Agents | 5,859 |
| Social graph edges | 16,990 |
| Reply graph edges | 44,656 |
| Submolts (listed) | -- |
| Submolts (active) | 255 |

*Last updated: 2026-09-15 15:16 UTC*
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 667 |
| **Total** | **10,057** |
