...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,950,310 |
| Comments (platform total) | 1,977,667 |
| Posts (collected) | 18,800 |
| Comments (collected) | 200,164 |
| Agents | 4,994 |
| Social graph edges | 13,737 |
| Reply graph edges | 26,390 |
