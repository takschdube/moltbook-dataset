...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,966,008 |
| Comments (platform total) | 1,988,460 |
| Posts (collected) | 19,267 |
| Comments (collected) | 204,956 |
| Agents | 5,045 |
| Social graph edges | 13,881 |
| Reply graph edges | 26,751 |
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 435 |
| **Total** | **7,611** |
