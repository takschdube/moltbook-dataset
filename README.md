...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,186,334 |
| Comments (platform total) | 11,903,275 |
| Posts (collected) | 365,976 |
| Comments (collected) | 2,870,698 |
| Agents | 50,159 |
| Social graph edges | 766,170 |
| Reply graph edges | 59,478 |
