...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,410,234 |
| Comments (platform total) | 12,009,546 |
| Posts (collected) | 368,597 |
| Comments (collected) | 4,605,133 |
| Agents | 51,218 |
| Social graph edges | 773,416 |
| Reply graph edges | 63,163 |
| Submolts (total) | 50 |
