...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 4,047,192 |
| Comments (platform total) | 2,042,679 |
| Posts (collected) | 21,437 |
| Comments (collected) | 230,196 |
| Agents | 5,229 |
| Social graph edges | 14,690 |
| Reply graph edges | 28,706 |
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 481 |
| **Total** | **8,074** |
