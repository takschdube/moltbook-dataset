...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,133,807 |
| Comments (platform total) | 11,881,923 |
| Posts (collected) | 365,386 |
| Comments (collected) | 2,866,774 |
| Agents | 49,851 |
| Social graph edges | 764,678 |
| Reply graph edges | 58,739 |
| Submolts (active) | 4,642 |
