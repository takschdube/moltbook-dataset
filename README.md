...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,511,838 |
| Comments (platform total) | 12,075,096 |
| Posts (collected) | 371,367 |
| Comments (collected) | 3,144,130 |
| Agents | 51,680 |
| Social graph edges | 774,876 |
| Reply graph edges | 63,979 |
