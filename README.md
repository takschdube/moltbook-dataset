...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 1,471,531 |
| Comments (platform total) | 12,222,906 |
| Posts (collected) | 360,972 |
| Agents | 47,241 |
| Social graph edges | 752,486 |
| Reply graph edges | 53,520 |
| Submolts (active) | 4,598 |

*Last updated: 2026-02-17 13:51 UTC*
