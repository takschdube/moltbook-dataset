...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,503,693 |
| Comments (platform total) | 12,057,761 |
| Posts (collected) | 369,649 |
| Comments (collected) | 3,143,690 |
| Agents | 51,516 |
| Social graph edges | 774,728 |
| Reply graph edges | 63,946 |
| Submolts (total) | 50 |
