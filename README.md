...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 4,285,918 |
| Comments (platform total) | 13,450,446 |
| Posts (collected) | 419,014 |
| Comments (collected) | 3,676,531 |
| Agents | 56,740 |
| Social graph edges | 823,966 |
| Reply graph edges | 924,102 |
