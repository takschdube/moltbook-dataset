...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,890,728 |
| Comments (platform total) | 1,929,767 |
| Posts (collected) | 17,080 |
| Comments (collected) | 179,432 |
| Agents | 4,817 |
| Social graph edges | 12,965 |
| Reply graph edges | 24,698 |
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 344 |
| **Total** | **6,997** |
