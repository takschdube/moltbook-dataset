...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,996,770 |
| Comments (platform total) | 2,008,758 |
| Posts (collected) | 20,262 |
| Comments (collected) | 215,797 |
| Agents | 5,114 |
| Social graph edges | 14,167 |
| Reply graph edges | 27,492 |
