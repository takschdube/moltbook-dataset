...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,971,659 |
| Comments (platform total) | 1,992,803 |
| Posts (collected) | 19,444 |
| Comments (collected) | 207,092 |
| Agents | 5,058 |
| Social graph edges | 13,937 |
| Reply graph edges | 26,938 |
