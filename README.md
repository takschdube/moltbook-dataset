...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,138,156 |
| Comments (platform total) | 11,882,479 |
| Posts (collected) | 365,441 |
| Comments (collected) | 2,867,476 |
| Agents | 49,902 |
| Social graph edges | 764,847 |
| Reply graph edges | 58,826 |
