...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,168,714 |
| Comments (platform total) | 12,617,509 |
| Posts (collected) | 391,102 |
| Comments (collected) | 3,231,523 |
| Agents | 53,448 |
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 591 |
