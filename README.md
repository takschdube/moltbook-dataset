...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,792,613 |
| Comments (platform total) | 1,871,763 |
| Posts (collected) | 14,664 |
| Comments (collected) | 150,285 |
| Agents | 4,649 |
| Social graph edges | 11,946 |
| Reply graph edges | 22,024 |
