...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,340,421 |
| Comments (platform total) | 12,734,940 |
| Posts (collected) | 394,332 |
| Comments (collected) | 3,263,677 |
| Agents | 53,673 |
| Social graph edges | 787,223 |
| Reply graph edges | 79,960 |
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 668 |
