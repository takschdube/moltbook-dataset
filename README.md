...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,905,521 |
| Comments (platform total) | 1,939,702 |
| Posts (collected) | 17,480 |
| Comments (collected) | 183,833 |
| Agents | 4,854 |
| Social graph edges | 13,098 |
| Reply graph edges | 25,017 |
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 361 |
| **Total** | **7,088** |
