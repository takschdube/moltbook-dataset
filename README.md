...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,241,406 |
| Comments (platform total) | 11,927,052 |
| Posts (collected) | 366,597 |
| Comments (collected) | 2,874,697 |
| Agents | 50,459 |
| Social graph edges | 768,189 |
| Reply graph edges | 60,054 |
| Submolts (active) | 4,662 |
