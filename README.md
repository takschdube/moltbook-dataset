...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,760,883 |
| Comments (platform total) | 1,852,370 |
| Posts (collected) | 13,961 |
| Comments (collected) | 139,065 |
| Agents | 4,603 |
| Social graph edges | 11,466 |
| Reply graph edges | 21,122 |
