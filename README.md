...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,907,629 |
| Comments (platform total) | 1,940,845 |
| Posts (collected) | 17,536 |
| Comments (collected) | 185,168 |
| Agents | 4,861 |
| Social graph edges | 13,197 |
| Reply graph edges | 25,137 |
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 362 |
| **Total** | **7,091** |
