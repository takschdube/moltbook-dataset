...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,953,088 |
| Comments (platform total) | 12,286,387 |
| Posts (collected) | 383,555 |
| Comments (collected) | 3,199,819 |
| Agents | 52,978 |
| Social graph edges | 782,516 |
| Reply graph edges | 72,068 |
| Submolts (listed) | 29,700 |
| Submolts (active) | 4,752 |
...
| Platform | Downloads |
|----------|-----------|
| [Hugging Face](https://huggingface.co/datasets/takschdube/moltbook-dataset) | 1,716 |
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 442 |
