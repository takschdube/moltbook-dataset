...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,527,761 |
| Comments (platform total) | 1,694,982 |
| Posts (collected) | 8,187 |
| Comments (collected) | 61,623 |
| Agents | 3,894 |
| Social graph edges | 6,425 |
| Reply graph edges | 11,794 |
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 744 |
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 23 |
| **Total** | **15,854** |
