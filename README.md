...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,272,883 |
| Comments (platform total) | 12,701,197 |
| Posts (collected) | 393,048 |
| Comments (collected) | 3,249,166 |
| Agents | 53,583 |
| Social graph edges | 786,278 |
| Reply graph edges | 77,942 |
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 637 |
