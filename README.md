...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,652,734 |
| Comments (platform total) | 1,777,787 |
| Posts (collected) | 11,452 |
| Comments (collected) | 97,247 |
| Agents | 4,319 |
| Social graph edges | 9,122 |
| Reply graph edges | 16,520 |
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 837 |
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 96 |
| **Total** | **16,387** |
...
| 2026-07 | 1,488 | 516 | 107 | 83 | 2,194 |
