...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,482,316 |
| Comments (platform total) | 12,047,087 |
| Posts (collected) | 369,305 |
| Comments (collected) | 3,141,595 |
| Agents | 51,434 |
| Social graph edges | 774,250 |
| Reply graph edges | 63,576 |
| Submolts (total) | 50 |
