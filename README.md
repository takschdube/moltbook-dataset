...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,049,749 |
| Comments (platform total) | 11,856,895 |
| Posts (collected) | 364,486 |
| Comments (collected) | 2,860,625 |
| Agents | 49,189 |
| Social graph edges | 762,917 |
| Reply graph edges | 57,619 |
| Submolts (active) | 4,632 |
