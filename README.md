...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,477,218 |
| Comments (platform total) | 12,044,880 |
| Posts (collected) | 369,249 |
| Comments (collected) | 3,141,203 |
| Agents | 51,412 |
| Social graph edges | 774,091 |
| Reply graph edges | 63,534 |
| Submolts (total) | 50 |
