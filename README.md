...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,190,667 |
| Comments (platform total) | 11,904,751 |
| Posts (collected) | 366,031 |
| Comments (collected) | 2,871,529 |
| Agents | 50,204 |
| Social graph edges | 766,591 |
| Reply graph edges | 59,614 |
