...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 4,138,889 |
| Comments (platform total) | 2,096,407 |
| Posts (collected) | 24,247 |
| Comments (collected) | 260,072 |
| Agents | 5,513 |
| Social graph edges | 15,925 |
| Reply graph edges | 31,134 |
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 596 |
| **Total** | **9,022** |
