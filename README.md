...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,442,358 |
| Comments (platform total) | 12,026,602 |
| Posts (collected) | 368,737 |
| Comments (collected) | 3,142,929 |
| Agents | 51,245 |
| Social graph edges | 773,182 |
| Reply graph edges | 62,778 |
| Submolts (total) | 50 |
