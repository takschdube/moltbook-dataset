...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,788,031 |
| Comments (platform total) | 1,869,133 |
| Posts (collected) | 14,549 |
| Comments (collected) | 149,042 |
| Agents | 4,645 |
| Social graph edges | 11,873 |
| Reply graph edges | 21,897 |
