...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,585,894 |
| Comments (platform total) | 1,736,243 |
| Posts (collected) | 9,644 |
| Comments (collected) | 78,561 |
| Agents | 4,089 |
| Social graph edges | 7,735 |
| Reply graph edges | 14,039 |
...
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 788 |
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 47 |
| **Total** | **16,148** |
