...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,482,598 |
| Comments (platform total) | 1,666,474 |
| Posts (collected) | 7,135 |
| Comments (collected) | 48,275 |
| Agents | 3,708 |
| Social graph edges | 5,582 |
| Reply graph edges | 9,746 |
| Submolts (listed) | 32,150 |
| Submolts (active) | 98 |

*Last updated: 2026-06-28 23:42 UTC*

<!-- DATASET_STATS_END -->

<!-- COVERAGE_NOTE_START -->

> **Note on platform totals.** The Moltbook API reports platform-wide aggregates (3.48M posts, 1.67M comments) that include content not accessible through the public API; the API documentation notes this explicitly. Our crawler performs exhaustive pagination across all 32,150 listed submolts using multiple sort orders (new, top, hot, rising) with overlap detection, and converges on ~7K posts with diminishing returns per crawl cycle. The gap between the reported platform total and the accessible collection is a property of the API, not a sampling limitation. Researchers should treat the collected subset as representative of publicly accessible content, not of the full platform.
...
| [Hugging Face](https://huggingface.co/datasets/takschdube/moltbook-dataset) | 4,082 |
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 723 |
