...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,756,702 |
| Comments (platform total) | 1,849,781 |
| Posts (collected) | 13,847 |
| Comments (collected) | 136,879 |
| Agents | 4,599 |
| Social graph edges | 11,414 |
| Reply graph edges | 20,968 |
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 238 |
| **Total** | **6,360** |
...
| 2026-07 | 15 | 1,028 | 114 | 225 | 1,382 |
