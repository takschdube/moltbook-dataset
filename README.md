...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,256,280 |
| Comments (platform total) | 11,932,858 |
| Posts (collected) | 366,766 |
| Comments (collected) | 2,876,077 |
| Agents | 50,515 |
| Social graph edges | 768,561 |
| Reply graph edges | 60,192 |
