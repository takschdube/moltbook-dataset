...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,933,466 |
| Comments (platform total) | 1,965,537 |
| Posts (collected) | 18,258 |
| Comments (collected) | 193,682 |
| Agents | 4,935 |
| Social graph edges | 13,565 |
| Reply graph edges | 25,875 |
