...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 4,100,797 |
| Comments (platform total) | 2,075,891 |
| Posts (collected) | 22,754 |
| Comments (collected) | 247,855 |
| Agents | 5,361 |
| Social graph edges | 15,220 |
| Reply graph edges | 30,039 |
