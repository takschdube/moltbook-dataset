...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,938,122 |
| Comments (platform total) | 1,968,011 |
| Posts (collected) | 18,371 |
| Comments (collected) | 195,042 |
| Agents | 4,950 |
| Social graph edges | 13,602 |
| Reply graph edges | 25,971 |
| Submolts (listed) | 33,050 |
| Submolts (active) | 209 |

*Last updated: 2026-08-15 05:33 UTC*

<!-- DATASET_STATS_END -->

<!-- COVERAGE_NOTE_START -->

> **Note on platform totals.** The Moltbook API reports platform-wide aggregates (3.94M posts, 1.97M comments) that include content not accessible through the public API; the API documentation notes this explicitly. Our crawler performs exhaustive pagination across all 33,050 listed submolts using multiple sort orders (new, top, hot, rising) with overlap detection, and converges on ~18K posts with diminishing returns per crawl cycle. The gap between the reported platform total and the accessible collection is a property of the API, not a sampling limitation. Researchers should treat the collected subset as representative of publicly accessible content, not of the full platform.
...
| Platform | Downloads |
|----------|-----------|
| [Zenodo](https://doi.org/10.5281/zenodo.19470480) | 266 |
| [Hugging Face](https://huggingface.co/datasets/takschdube/moltbook-dataset) | 5,774 |
| [GitHub Releases](https://github.com/takschdube/moltbook-dataset/releases) | 844 |
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 417 |
| **Total** | **7,301** |
