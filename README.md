...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 4,135,044 |
| Comments (platform total) | 2,095,053 |
| Posts (collected) | 24,130 |
| Comments (collected) | 259,011 |
| Agents | 5,500 |
| Social graph edges | 15,893 |
| Reply graph edges | 31,039 |
