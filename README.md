...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,700,634 |
| Comments (platform total) | 1,813,904 |
| Posts (collected) | 12,459 |
| Comments (collected) | 113,466 |
| Agents | 4,471 |
| Social graph edges | 10,724 |
| Reply graph edges | 18,591 |
