...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,975,897 |
| Comments (platform total) | 1,995,034 |
| Posts (collected) | 19,557 |
| Comments (collected) | 208,453 |
| Agents | 5,068 |
| Social graph edges | 13,975 |
| Reply graph edges | 27,051 |
| Submolts (listed) | 33,100 |
| Submolts (active) | 225 |

*Last updated: 2026-08-20 05:32 UTC*
...
| [Kaggle](https://www.kaggle.com/datasets/takschdube/moltbook-dataset) | 439 |
| **Total** | **7,674** |
