...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 3,766,820 |
| Comments (platform total) | 1,857,683 |
| Posts (collected) | 14,085 |
| Comments (collected) | 141,520 |
| Agents | 4,611 |
| Social graph edges | 11,509 |
| Reply graph edges | 21,320 |
