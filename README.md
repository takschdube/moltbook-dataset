...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 1,885,917 |
| Comments (platform total) | -- |
| Posts (collected) | 363,760 |
| Agents | 48,798 |
| Social graph edges | 761,773 |
| Reply graph edges | 57,110 |
| Submolts (active) | 4,625 |

*Last updated: 2026-03-07 02:26 UTC*
