...
| Metric | Count |
|--------|-------|
| Posts (platform total) | 2,485,563 |
| Comments (platform total) | 12,048,634 |
| Posts (collected) | 369,361 |
| Comments (collected) | 3,142,089 |
| Agents | 51,451 |
| Social graph edges | 774,358 |
| Reply graph edges | 63,704 |
| Submolts (total) | 50 |
| Submolts (active) | 4,696 |
